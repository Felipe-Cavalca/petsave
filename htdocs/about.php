					...
					<div class="row justify-content-center align-items-center">
						<div class="col-lg-8">
							...
							<div class="description">
								<h4>Assista o vídeo acima para conhecer melhor nosso trabalho.</h4>
								<p>
									Aperte o play 
								</p>								
							</div>
				...
				<div class="container-fluid">
					<div class="row align-items-center">	
						...
						<div class="col-lg-6 home-about-right no-padding">
							<h1>
			A Nossa Missão 		</h1>
				<h5>Nossos objetivos para ajudar a sociedade para com os animais </h5>
							<p>
							...
							<a href="#" class="primary-btn text-uppercase">Contate-nos</a>
						</div>
					</div>
				</div>	
			</section>
					...
					<div class="row d-flex justify-content-center">
						<div class="menu-content pb-60 col-lg-8">
							<div class="title text-center">
								<h1 class="mb-10">Administradores/ Desenvolvedores </h1>
								<p>&nbsp;</p>
							</div>
						</div>
					</div>						
					<div class="row">
						<div class="active-testimonial-carusel">
						  <div class="single-testimonial item">
								<p><img class="mx-auto" src="img/t1.png" alt=""></p>
								<p>&nbsp; </p>
								<h4>Izabella Souza </h4>
								<p>
									Admin</p>
						  </div>	
							<div class="single-testimonial item">
								<p><img class="mx-auto" src="img/t2.png" alt=""></p>
								<p>&nbsp; </p>
								<h4>Kaylan Bruno </h4>
								<p>
									Admin</p>
							...
							<div class="single-testimonial item">
								<p><img class="mx-auto" src="img/t3.png" alt=""></p>
								<p>&nbsp; </p>
								<h4>Felipe Santos </h4>
								<p>Admin</p>
							</div>														
