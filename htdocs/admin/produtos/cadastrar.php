...
<?php
	...
	<head>
				      ...
				      <nav id="nav-menu-container">
				        <ul class="nav-menu">
				          ...
				          <li><a href="../administrador/select.php">Administradores</a></li>
                                          <li><a href="select.php">Voltar</a></li>
        ...
        <form name="form" method="post" action="insert.php" >
                ...
                <input class="campo" type="descricao" name="descricao" />
            </p>
            </p>
                <label> tipo </label> <br />
                <input class="campo" type="tipo" name="tipo" />
            </p>
            <p>
                <label> valor </label> <br />
                <input class="campo" type="valor" name="valor" />
            </p>
            <p>
                <label> Quantidade </label> <br />
                <input class="campo" type="qtd" name="qtd" />
            </p>
            <p>
